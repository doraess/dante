...
(function() {
  ...
  enableWs = function() {
    console.log(render(socket, void 0, 10));
    if (!socket) {
      socket = new WebSocket('ws://doraess.no-ip.org:3900/pebble');
      socket.addEventListener("open", function() {
        if (debug) {
          console.log("----> Websocket abierto".green);
        }
        return socket.send("Pebble conectado");
      });
  ...
  disableWs = function() {
    ...
    return console.log(render(socket, void 0, 10));
  };
  ...
  Pebble.addEventListener("webviewclosed", function(e) {
    if (e.response) {
      ...
      if (config.ws_enabled === true) {
        ...
        if (debug) {
          console.log("----> Deshabilitando sebsocket...\n".yellow);
        }
        return disableWs();
      }
    }
